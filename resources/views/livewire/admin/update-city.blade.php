    <div class="md:mt-2 md:mb-4">
        <h1 class="font-bold py-4 text-center">Update City</h1>
        <hr>
        ...
        <div class=" pt-4 flex flex-col items-center">
            ...
            <form wire:submit='updateCity' class="w-full md:w-1/2 flex flex-col gap-4">
                ...
                <flux:button variant="primary" type="submit" class="">{{ __('Update City') }}</flux:button>
